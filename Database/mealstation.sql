...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2022 at 01:39 PM
...
(22, 'Ice Cream', 40, 'media/items/icecream-cone.png', 3, 'YES');
...
(15, 1, 100, '2022-05-19', 1, 15, '7524977820', 'Ready', 'pod', 100, '29534'),
(16, 1, 40, '2022-05-20', 1, 20, '7524977820', 'Pending', 'pod', 40, '29534'),
(31, 3, 40, '2022-06-01', 5, 22, '7524977820', 'Pending', 'qrcode', 120, '29534');
...
(2, 'Time must be in 24 hour format', '08:00:00.000000', '09:45:00.000000', 'Click Here');

-- --------------------------------------------------------

--
-- Table structure for table `cafe_static`
--

CREATE TABLE `cafe_static` (
  `id` bigint NOT NULL,
  `name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `cafe_static`
--

INSERT INTO `cafe_static` (`id`, `name`) VALUES
(1, 'asdf');
...
--
-- Indexes for table `cafe_static`
--
ALTER TABLE `cafe_static`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cafe_static`
--
ALTER TABLE `cafe_static`

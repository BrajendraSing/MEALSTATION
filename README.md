...
```The purpose of Meal Station is to automate the existing manual system by the help of computerized
...
```
```
### Meal Station, as described above, can lead to error free, secure, reliable and fast management

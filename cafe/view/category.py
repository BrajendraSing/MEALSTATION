...
from cafe.models import Category, Customer, ManageCart
from cafe.models.admin import Items
from cafe.models.admin.items import get_item_by_id
from cafe.view.cart_count import Cart_Count
from cafe.models.admin.items import get_items_by_category,check_stock
from cafe.models.admin.category import fetch_category_by_id
...
class CategoryList(View):
    ...
    def get(self, request, catId):
        ...
        data['category'] = fetch_category_by_id(catId)
        data['items'] = get_items_by_category(catId)
        data['stock'] = check_stock()
